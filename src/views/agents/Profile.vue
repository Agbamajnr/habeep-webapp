<template>
    <div class="w-screen min-w-full flex flex-col items-center bg-white h-full min-h-screen overflow-y-auto"
        ...
        <div
            class="body px-6 2xl:px-44 md:px-20 mb-10 w-full flex flex-row h-fit gap-x-3 items-center md:items-start  mt-10">
            <!-- agent basic info -->
            <div
                class="agent-info md:flex hidden p-4 bg-white flex-col border border-gray-300 rounded w-2/3 xl:w-2/6 2xl:w-1/4 items-start ml-3 h-fit">
                <div class="flex flex-row gap-x-2 items-start">
                    ...
                    <div class="flex flex-col ">
                        <span
                            class="text-sm xl:text-xl md:text-center text-left agent-name text-webapp font-medium">Duke
                            Carrick</span>
                ...
                <p class="text-sub-webapp text-sm text-left w-full mt-1 xl:mt-2">
                ...
                <div class="flex flex-col xl:flex-row items-center w-full gap-y-1 xl:justify-between mt-1 xl:mt-3">
                    <button
                        class="agent-btn hidden xl:flex flex-row items-center justify-center text-sm font-medium text-white text-primary w-1/2  bg-primary">Follow</button>
                    <button
                        class="agent-btn flex flex-row items-center justify-center text-sm font-medium w-full text-primary ml-2 bg-white xl:w-1/2">Message</button>
                </div>
            </div>
            ...
            <div class="flex flex-col items-start w-4/5">
                <div class="flex flex-row gap-x-3 border-b border-b-gray-300 w-full">
                    <div class="cursor-pointer border-b-2 flex flex-row items-center justify-center w-16 text-blue-700 pb-1 border-b-blue-700">
                        Ads
                    </div>
                    <div class="cursor-pointer border-b-2 flex flex-row items-center justify-center w-24 text-blue-700 pb-1 border-b-blue-700">
                        Saved ads
                    </div>
                </div>

                <div class="ads-tab w-full h-full mt-6">
